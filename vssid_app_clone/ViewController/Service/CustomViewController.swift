...
class CustomViewController: UIPageViewController {
...
extension CustomViewController {
    ...
    func setup() {
        ...
        let page1 = ListNotiViewController()
        let page2 = ListNotiViewController()
...
extension CustomViewController: UIPageViewControllerDataSource {
...
extension CustomViewController: UIPageViewControllerDelegate {
